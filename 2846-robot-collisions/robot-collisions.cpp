...
public:
    ...
    vector<int> survivedRobotsHealths(vector<int>& positions,
        ...
        for (auto& robot : vals) {
            ...
            while (!stack.empty() && stack.back().health <= robot.health &&
                   stack.back().direction == 'R') {
            ...
            // If the robot is not yet eliminated and there is a robot facing
            // right with higher health
            if (!gone && !stack.empty() && stack.back().direction == 'R' &&
